...
public class PersonMainUsingAnnotation {
	
	private static Logger logger = LoggerFactory.getLogger(PersonMainUsingAnnotation.class);
	
	public static void main(String[] args)
	{
		ApplicationContext appCtx = new ClassPathXmlApplicationContext("person/spring-person-annotation-config.xml");
